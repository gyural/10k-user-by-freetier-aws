...
public class ParkingFeeRuleRepositoryTest {
    ...
    void testFindAllByParkingZoneEntity_Id() {
        ...
        List<ParkingFeeRuleEntity> rules = parkingFeeRuleRepository.findAllByParkingZoneEntity_Id(seoulParking.getId());
    ...
    void testFindAllByParkingZoneEntity_Id_NoResults() {
        ...
        List<ParkingFeeRuleEntity> rules = parkingFeeRuleRepository.findAllByParkingZoneEntity_Id(999L); // 존재하지 않는 ID
